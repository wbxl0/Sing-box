...
const UUID = process.env.UUID || '033870d0-3832-4d35-91b7-9009d442ec90';  // 在不同的平台运行了v1哪吒请修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'v1.wbxl.dpdns.org:10024';         // 哪吒面板地址,v1形式：nz.serv00.net:8008  v0形式：nz.serv00.net
const NEZHA_PORT = process.env.NEZHA_PORT || '';             // v1哪吒请留空，v0 agent端口，当端口为{443,8443,2087,2083,2053,2096}时，自动开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || 'fXYWSXfEZbSHMuGHEhcJjisCWDInLBtR';               // v1的NZ_CLIENT_SECRET或v0 agwnt密钥 
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'wd.wbxl00.ggff.net';           // argo固定隧道域名,留空即使用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNTI2NjQ3MGU5ZmZiZmYwMWU1ZmI5Yzk1NjExNjZhZmYiLCJ0IjoiYzE3OWQ2ZjEtOTFiMC00NzcxLWFlMGEtNTk1NWM5MTE0OTg1IiwicyI6Ik5tSmlORE5tTXpFdE1EWTFZeTAwWXpjMExUZ3lNbVl0WXpCaU5XUmhOVEk1WkRFMiJ9';               // argo固定隧道token或json,留空即使用临时隧道
...
const NAME = process.env.NAME || 'weird1';                         // 节点名称
