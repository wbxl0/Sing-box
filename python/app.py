...
UUID = os.environ.get('UUID', '09e19e2f-c6b2-49f9-a5c4-11476e8527a2')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'v1.wbxl.dpdns.org:10024')      # 哪吒面板域名或ip, v1格式: nz.serv00.net:8008, v0格式: nz.serv00.net
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')          # v1哪吒请留空, v0哪吒的agent通信端口
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'fXYWSXfEZbSHMuGHEhcJjisCWDInLBtR')            # v1哪吒的NZ_CLIENT_SECRET或v0哪吒agent密钥
...
S5_PORT_STR = os.environ.get('S5_PORT', '')            # socks5端口，支持多端口的可以填写，否则留空
...
ANYTLS_PORT_STR = os.environ.get('ANYTLS_PORT', '')    # AnyTLS端口，支持多端口的可以填写，否则留空
REALITY_PORT_STR = os.environ.get('REALITY_PORT', '')  # Reality端口,支持多端口的玩具可以填写开启,否则保持不变
ANYREALITY_PORT_STR = os.environ.get('ANYREALITY_PORT', '')  # Anyr-eality端口，支持多端口的可以填写，否则留空
...
DISABLE_ARGO = os.environ.get('DISABLE_ARGO', 'false').lower() == 'true'  # 设置为 true 时禁用argo,false开启
